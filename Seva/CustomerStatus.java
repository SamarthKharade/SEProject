...
public class CustomerStatus extends JFrame implements ActionListener {
     String orgname;
     Vector v;
     JButton cancel;
   JTable table;
    JScrollPane scrollPane;
    public CustomerStatus(String oname) {
        orgname=oname;
         setLayout(null);
         ...
         try {
            ...
            DatabaseInfo c = new DatabaseInfo();
                  ...
                  ResultSet rs = c.s.executeQuery("select * from helpinformation where name='"+orgname+"'");
