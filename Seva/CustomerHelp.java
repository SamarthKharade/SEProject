 ...
 * @author samar
 */
public class CustomerHelp extends JFrame implements ActionListener {
    String s="Incomplete";
   Vector v;
     JButton cancel;
   JTable table;
...
try {
            ...
            DatabaseInfo c = new DatabaseInfo();
                  ...
                  ResultSet rs = c.s.executeQuery("select useby,name,helpinfo from helpinformation where sdetail='"+s+"'");
